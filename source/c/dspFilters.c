...
dspFilterConvFft(double* signal, unsigned int ns, 
    ...
    int detrend_option, int window_option)
{
...
double*
dspIIR_SincTrapezLowPass(unsigned int n, double dt, double fc, double ramp)
{
...
{   
	...
	signal = dspFilterConvFft(signal, ns, filter_kernel, nf, DETREND_LINEAR, HANNING_WINDOW);
